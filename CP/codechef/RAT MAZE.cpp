...
ll co=0;
vector<vector<long int>>obstacles;
...
if(start_i>n||start_j>m||obstacles[start_i][start_j]==1)
    return;
//recur
...
//if(start_i==start_j)
//to_reach(start_i+1,start_j+1,n,m,osf+'H');
...
int main(){
long int start_i=0,start_j=0,n,input;
cin>>n;
obstacles.resize(n);
FORS(i,0,n)
{
...
to_reach(start_i,start_j,n-1,n-1,"");
cout<<co;
}
